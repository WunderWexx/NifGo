...
class NutrinomicsReport(wd):
    ...
    def nutrinomics_IA(self):
        ...
        nutrinomics_genes = [
        "ABCB1", "ACE", "ADIPOQ", "ADRA2A", "ALDH2", "AMDHD1", "BChE", "BCO1",
        "BDNF-AS; BDNF", "CAGNA1S", "CFTR", "CYP1A1", "CYP1B1", "CYP2A6",
        "CYP2C8", "CYP2E1", "CYP2F1", "CYP2R1", "CYP4F2", "CYP17A", "CYP24A1",
        "DHCR7", "DRD2", "F2", "F5", "FTO", "GC", "IFNL3/IL28B", "GCK, YKT6",
        "GSTM1", "GSTP1", "GSTT1", "HLA-B*3101", "IGF1", "LDLR",
        "LOC105447645; FUT2", "MAO-B", "MC4R", "MnSOD", "MTHFR1298", "MTRNR1",
        "MTNR1B", "NADSYN1", "NAT1", "NAT2", "NBPF3", "NQ01", "OPRM1", "PON1",
        "RYR1", "Sult1A1", "Sult1E1", "TCF7L2", "TMEM165; CLOCK", "TNFa",
        "UCP2", "VDR"
        ]
