...
class DocumentFormatting:
    ...
    def styled_cell_text(self, cell, text, make_bold=False, chosen_font='Calibri', chosen_size=11, set_linespacing=False):
    ...
    def styled_run(self, run, font_name = "Calibri", font_size = 11, is_bold = False, is_italic = False, is_underlined = False):
    ...
    def change_table_cell(self,cell, background_color=None, font_color=None, font_size=None, bold=None, italic=None):
    ...
    def change_table_row(self, table_row, background_color=None, font_color=None, font_size=None, bold=None, italic=None):
